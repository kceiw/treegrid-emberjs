/**
 * @file Defines the tree grid component.
 * @author maoliang
 */
...
DemoApp.TreeGridComponent = Ember.Component.extend({
    ...
    actions: {
        /**
         * Set the selected row and it's isSelected property.
         */
    ...
    /**
     * Changes the expanded/collapsed state of the selected row.
     */
     ...
     * @private
     * @param {TreeGrid.RowModel} row The row from where to get the previous row
     * @return {TreeGrid.RowModel} The previous visible row.
     */
     ...
     * @private
     * @param {TreeGrid.RowModel} row The row whose desendent to look for
     * @return {TreeGrid.RowModel}
     */
